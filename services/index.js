...
if (!graphqlAPI) {
  console.error("CRITICAL: NEXT_PUBLIC_GRAPHCMS_ENDPOINT is not defined. Check your .env.local file.");
  // You might want to throw an error here or handle it appropriately
  // For now, this will prevent the app from crashing if it's missing during build/runtime
}

export const getPosts = async () => {
  if (!graphqlAPI) return []; // Return empty if API endpoint is missing
  const query = gql`
    query MyQuery {
