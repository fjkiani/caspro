...
const EnhancedDossierSummary: React.FC<EnhancedDossierSummaryProps> = ({
  ...
  const { getTextSize, getCardClass } = useAccessibilityFallback();
  ...
  return (
    <div className={`${getCardClass('bg-white dark:bg-slate-800')} p-8 rounded-2xl border-2 border-slate-200 dark:border-slate-700 shadow-lg ${className}`}>
      {/* Header */}
