          ...
          <div className="w-full max-w-[700px] aspect-[16/9] max-h-[min(48vw,250px)] sm:max-h-none mx-auto">
            <ResponsiveContainer width="100%" height="100%">
              <ComposedChart data={TRAJECTORY}>
                <defs>
                  <linearGradient id="heroCtdna" x1="0" y1="0" x2="0" y2="1">
                  ...
                  <linearGradient id="heroIntercept" x1="0" y1="0" x2="0" y2="1">
                ...
                <Area type="monotone" dataKey="ctdna" stroke={isDarkMode ? '#06b6d4' : '#6366f1'} strokeWidth={3} fill="url(#heroCtdna)" />
                <Area data={INTERCEPT} type="monotone" dataKey="val" stroke="#10b981" strokeWidth={4} fill="url(#heroIntercept)" animationDuration={2000} />
...
export default KillChainPreview;
