    ...
    <div className={`border rounded-sm flex flex-col relative overflow-hidden shadow-2xl transition-colors duration-500 ${
      ...
      <div className="flex justify-center gap-6 pb-3 px-4">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[8px] font-black uppercase zeta-evidence-label">Trial</span>
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-2 h-2 rounded-full border border-emerald-500" />
          <span className="text-[8px] font-black uppercase zeta-evidence-label">Responder</span>
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-2 h-2 rounded-full border border-rose-500 border-dashed" />
          <span className="text-[8px] font-black uppercase zeta-evidence-label">Non-Resp</span>
        </div>
      </div>
      ...
      <div className={`mx-4 mb-4 p-4 border rounded transition-colors ${
        ...
        <div className="flex justify-between items-center mb-2">
          <span className="zeta-evidence-label">cos(θ) Responder</span>
          <span className={`text-sm font-light ${isDarkMode ? 'text-white' : 'text-slate-950'}`}>{trial.cosineResponder.toFixed(4)}</span>
        </div>
        <div className="flex justify-between items-center mb-2">
          <span className="zeta-evidence-label">cos(θ) ITT Diluted</span>
          <span className="text-sm font-light text-rose-500">{trial.cosineITT.toFixed(4)}</span>
        </div>
