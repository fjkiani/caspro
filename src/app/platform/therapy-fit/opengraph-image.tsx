...
export const alt = 'Therapy Fit — CrisPRO.ai Platform Capability';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ fontSize: 30, color: '#cbd5e1', maxWidth: 960, lineHeight: 1.2 }}>
            Precision therapy selection & sequencing
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ fontSize: 20, color: '#94a3b8' }}>crispro.ai/platform/therapy-fit</div>
        </div>
      </div>
    ),
    { ...size }
