...
const SLUG = 'toxicity-risk';
const SITE_URL = 'https://crispro.ai';

export default function ToxicityRiskPage() {
  ...
  return (
    <>
      <BreadcrumbListJsonLd
        id="toxicity-risk-breadcrumb-jsonld"
        items={[
          { name: 'Home', item: SITE_URL },
          { name: 'Platform', item: `${SITE_URL}/platform` },
          { name: 'Toxicity Risk', item: canonical },
        ]}
      />
      <FaqPageJsonLd
        id="toxicity-risk-faq-jsonld"
        entries={content.faq.map((f) => ({ question: f.question, answer: f.answer }))}
      />
      <SoftwareApplicationJsonLd
        id="toxicity-risk-software-jsonld"
