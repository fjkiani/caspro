...
export const alt = 'Toxicity Risk — CrisPRO.ai Platform Capability';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ fontSize: 30, color: '#cbd5e1', maxWidth: 960, lineHeight: 1.2 }}>
            Predictive adverse event & tolerability modeling
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ fontSize: 20, color: '#94a3b8' }}>crispro.ai/platform/toxicity-risk</div>
        </div>
      </div>
    ),
    { ...size }
