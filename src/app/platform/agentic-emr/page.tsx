...
const SLUG = 'agentic-emr';
const SITE_URL = 'https://crispro.ai';

export default function AgenticEmrPage() {
  ...
  return (
    <>
      <BreadcrumbListJsonLd
        id="agentic-emr-breadcrumb-jsonld"
        items={[
          { name: 'Home', item: SITE_URL },
          { name: 'Platform', item: `${SITE_URL}/platform` },
          { name: 'AgenticEMR', item: canonical },
        ]}
      />
      <FaqPageJsonLd
        id="agentic-emr-faq-jsonld"
        entries={content.faq.map((f) => ({ question: f.question, answer: f.answer }))}
      />
      <SoftwareApplicationJsonLd
        id="agentic-emr-software-jsonld"
