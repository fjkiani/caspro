...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: 'Transform genetic testing from VUS crisis to precision diagnostics with AI-powered variant interpretation and automated workflows.',
  };
}
    ...
    <main className="min-h-screen bg-slate-900 text-slate-100">
      <div className="max-w-7xl mx-auto px-6 py-12 space-y-16">
        ...
        <BusinessTransformation
          productName="Oracle"
          valuePropositions={geneticTestingTransformationContent.valuePropositions}
          summary={geneticTestingTransformationContent.summary}
        />
