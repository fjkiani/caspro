/**
 * Hereditary Breast Cancer: Component-Driven Architecture
 * 
 * This deck demonstrates the new component-driven approach:
...
const Brand = () => (
  <div className="absolute bottom-6 right-6 z-20 text-lg font-semibold text-slate-400/70">
    {hereditaryBreastCancerDeckConfig.branding.company} {hereditaryBreastCancerDeckConfig.branding.icon}
  </div>
);
...
// --- MAIN COMPONENT ---
const HereditaryBreastCancerComponentDrivenDeck: React.FC = () => {
  const [currentSlide, setCurrentSlide] = useState(0);
  const [isPlaying, setIsPlaying] = useState(false);

  // Generate slides using the component factory
  const slideComponents = createComponentDrivenSlides(hereditaryBreastCancerDeckConfig);
...
export default HereditaryBreastCancerComponentDrivenDeck;
