...
export const coPilotDetailsData: Record<string, CoPilotDetailContent> = {
    ...
    valueProps: [
      {
        ...
        icon: 'Users',
        points: [
          'Personalize treatment plans based on predicted radio-sensitivity.',
          'Proactively manage and minimize patient toxicity.',
          'Adapt therapy in real-time to improve tumor control.'
        ]
      },
      {
        audience: 'Medical Physicists',
        icon: 'Microscope',
        points: [
          'Incorporate biological targets directly into dosimetry.',
          'Automate quality assurance for complex, adaptive plans.',
          'Contribute to building novel, data-driven treatment protocols.'
        ]
      }
    ],
    buildsOn: "PrecisionRad is built on a foundation of integrated, multi-modal data analysis.",
    buildsOnStackPoints: [
      "**`AI-Powered Radio-Genomics`:** By analyzing key DNA Damage Response (DDR) genes, the AI predicts tumor sensitivity and normal tissue toxicity.",
      "**`Quantitative Radiomics`:** Extracts thousands of hidden features from CT, PET, and MRI scans to create predictive models of treatment response.",
      "**`Adaptive Therapy Engine`:** Continuously monitors on-treatment imaging to recommend adjustments, ensuring the plan remains optimal."
    ],
  ...
  "agentic-emr": {
    ...
    "vision": " transform complex patient data from genomics to clinical history into clear, actionable insights, streamlining care coordination, accelerating research, and empowering clinicians to deliver the most advanced and personalized cancer care possible.",
    valueProps: [
       {
        audience: 'Clinical Oncologists',
        icon: 'Users',
        points: [
          'Get a unified, longitudinal view of your patient in seconds.',
          'Instantly match patients to relevant clinical trials.',
          'Collaborate more effectively with your multi-disciplinary team.'
        ]
      },
      {
        ...
        icon: 'BrainCircuit',
        points: [
          'Accelerate research by identifying patient cohorts faster.',
          'Increase clinical trial enrollment rates significantly.',
          'Unlock new insights from your existing clinical data.'
        ]
      }
    ],
    ...
    "buildsOn": "The Oncology Co-Pilot is built on a sophisticated AI agent architecture, where specialized agents collaborate to provide deep, contextual insights. It moves beyond simple data retrieval to perform complex analysis and workflow automation:",
    "buildsOnStackPoints": [
      "`Deep Variant Interpretation`:  doesn't just list mutations; it assesses their functional impact, classifying them with terms like 'activating mutation' to provide immediate clinical context.",
      "`Automated Eligibility Screening`: automatically scans patient records against complex trial criteria, extracting key data points from clinical notes and structured data to confirm eligibility.",
      "**From Analysis to Action:** The platform connects `genomic findings` to `therapeutic possibilities`, offering workflows to translate a high-impact variant into a potential `gene-editing research strategy`.",
      "**Contextual Decision Support:** During real-time consultations, clinicians can invoke `specialized agents` to ask complex questions and receive AI-generated summaries and therapeutic comparisons directly within their workflow.",
      "**Proactive Patient Management:** Clinicians can build custom agents to automate highly specific, time-consuming research tasks, such as monitoring new publications related to specific patient cohorts or resistance pathways.",
      "**Holistic Patient Summarization:** Before a patient visit, the `DataAnalysisAgent` can be triggered to generate a 'deep dive' summary, pulling not just the latest lab values but also insights from conceptual agents to provide a truly holistic patient overview."
    ],
    "genomicUseCasesGrid": [
  ...
  "crispr-intelligence": {
    ...
    valueProps: [
      {
        audience: 'Biotech & Pharma R&D',
        icon: 'Microscope',
        points: [
          'De-risk your therapeutic pipeline with in-silico target validation.',
          'Shorten the timeline from discovery to pre-clinical candidates.',
          'Design safer, more effective gene editing components.'
        ]
      },
      {
        ...
        icon: 'BrainCircuit',
        points: [
          'Explore more therapeutic hypotheses with high-throughput in-silico screening.',
          'Generate publication-quality designs and predictions.',
          'Focus your lab resources on the most promising candidates.'
        ]
      }
    ],
    ...
    "buildsOn": "CRISPR Intelligence is built on state-of-the-art predictive and generative AI models.",
    "buildsOnStackPoints": [
      "**`Predictive AI (Evo 2)`**: Assesses the functional impact of edits to validate therapeutic targets before any experiment is run.",
      "**`Generative AI`**: Designs thousands of optimal guide RNA sequences and homology repair templates in parallel.",
      "**`In-Silico Screening`**: Simulates experiments to predict on-target efficiency and off-target risks, saving valuable lab time and resources."
    ],
    "genomicUseCasesGrid": [
    ...
    "conclusion": "CRISPR Intelligence transforms therapeutic design from a manual, iterative process into a scalable, AI-driven workflow, bringing gene therapies to patients faster."      
  }
}; 