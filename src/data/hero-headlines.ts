...
export const HERO_HEADLINES: Record<string, HeadlineEntry[]> = {
  ...
  adavosertib: [
    {
      ...
      highlight: 'We locked the failure prediction before JCO 2023.',
      trial: 'ADAVOSERTIB › NCT03579316 › JCO 2023',
      evidence: {
        title: 'Trial Receipt (Public)',
        rows: [
          { label: 'Registry', value: 'NCT03579316', color: 'muted' },
          { label: 'Modality', value: 'WEE1i + Gemcitabine', color: 'muted' },
          { label: 'Analysis', value: 'LOCKED', color: 'accent' },
        ],
        impact: 'Receipt Status',
        impactValue: 'PRE-READOUT',
    ...
    {
      text: 'Predicted biomarker split before outcome publication.',
      highlight: 'Mechanistic root cause withheld until passcode.',
      trial: 'ADAVOSERTIB › Retroactive Validation',
      evidence: {
        title: 'Diligence Package',
        rows: [
          { label: 'Sponsor', value: 'AstraZeneca', color: 'muted' },
          { label: 'Phase', value: 'Phase II', color: 'muted' },
          { label: 'Stratification', value: 'REDACTED', color: 'accent' },
        ],
        impact: 'Full Case File',
        impactValue: 'PASSCODE',
  ...
  berzosertib: [
    {
      text: 'Berzosertib Phase II. Survival split by biomarker stratum.',
      highlight: 'Retroactive case locked before diligence review.',
      trial: 'BERZOSERTIB › NCT02595892',
      evidence: {
        title: 'Trial Receipt (Public)',
        rows: [
          { label: 'Registry', value: 'NCT02595892', color: 'muted' },
          { label: 'Modality', value: 'ATRi + Gemcitabine', color: 'muted' },
          { label: 'Analysis', value: 'LOCKED', color: 'accent' },
        ],
        impact: 'Receipt Status',
        impactValue: 'PRE-READOUT',
    ...
    {
      text: 'Heterogeneous benefit observed across enrolled cohorts.',
      highlight: 'Patient selection logic withheld until passcode.',
      trial: 'BERZOSERTIB › Retroactive Validation',
      evidence: {
        title: 'Diligence Package',
        rows: [
          { label: 'Sponsor', value: 'Merck KGaA', color: 'muted' },
          { label: 'Phase', value: 'Phase II', color: 'muted' },
          { label: 'Stratification', value: 'REDACTED', color: 'accent' },
        ],
        impact: 'Full Case File',
