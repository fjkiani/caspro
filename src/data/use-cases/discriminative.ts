...
export const hereditaryBreastCancer: UseCase = {
  ...
  tags: ['BRCA1', 'Hereditary Cancer', 'VUS Resolution'],
  steps: [
    {
      id: 'variant_impact',
...
export const oncogeneActivation: UseCase = {
  ...
  category: 'discriminative',
  tags: ['KRAS', 'Oncogene', 'Drug Target'],
  steps: [
    {
      id: 'variant_impact',
      title: 'Variant Impact Prediction',
...
export const therapeuticTargeting: UseCase = {
  ...
  category: 'discriminative',
  tags: ['Target Validation', 'Gene Essentiality', 'Synthetic Lethality'],
  steps: [
    {
      ...
      input: (ctx) => ({ 
        gene: ctx.seed.gene, 
        contexts: [
          { cell_line: ctx.seed.contextA }, 
          { cell_line: ctx.seed.contextB }
        ] 
      }),
      runMode: 'simulate'
    }
...
export const discriminativeUseCases = [
