...
import EssentialityChart from '@/components/sae/components/EssentialityChart';
import ProteinDeltaCard from '@/components/sae/components/ProteinDeltaCard';
import AccessibilityTrack from '@/components/sae/components/AccessibilityTrack';
  ...
  multiModalPredictions: [
    {
      ...
      metrics: [
        { value: '0.82-0.99', label: 'AUROC Range', color: 'text-green-600' },
        { value: '8 Species', label: 'Cross-Species', color: 'text-blue-600' }
      ],
      keyFeatures: [
    ...
    },
    {
      ...
      metrics: [
        { value: 'Strong', label: 'DMS Correlation', color: 'text-red-600' },
        { value: 'Competitive', label: 'vs Specialists', color: 'text-orange-600' }
      ],
      keyFeatures: [
    ...
    },
    {
      ...
      metrics: [
        { value: 'SAE TF', label: 'Motif Features', color: 'text-orange-600' },
        { value: 'DART-Eval', label: 'Validated', color: 'text-purple-600' }
      ],
      keyFeatures: [
  ...
  scientificValidation: [
    {
      ...
      metrics: [
        { value: '95.7%', label: 'SNV AUROC', color: 'text-cyan-600' },
        { value: '93.9%', label: 'Non-SNV AUROC', color: 'text-blue-600' }
      ],
      keyFeatures: [
    ...
    },
    {
      ...
      metrics: [
        { value: '94%', label: 'Supervised AUROC', color: 'text-green-600' },
        { value: '89.1%', label: 'Zero-shot AUROC', color: 'text-purple-600' }
      ],
      keyFeatures: [
    ...
    },
    {
      ...
      metrics: [
        { value: '82.6%', label: 'SpliceVarDB AUROC', color: 'text-orange-600' },
        { value: 'Exonic/Intronic', label: 'Both Supported', color: 'text-red-600' }
      ],
      keyFeatures: [
