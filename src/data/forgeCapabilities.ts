  ...
  multiModalGeneration: [
    {
      ...
      metrics: [
        { value: '92%', label: 'On-target efficiency', color: 'text-green-600' },
        { value: '<0.1', label: 'Off-target score', color: 'text-blue-600' },
        { value: '~30s', label: 'Design time', color: 'text-purple-600' }
      ],
      keyFeatures: [
    ...
    },
    {
      ...
      metrics: [
        { value: '78%', label: 'HDR efficiency', color: 'text-green-600' },
        { value: '4.2kb', label: 'Avg arm length', color: 'text-blue-600' },
        { value: '94%', label: 'Success rate', color: 'text-purple-600' }
      ],
      keyFeatures: [
    ...
    },
    {
      ...
      metrics: [
        { value: '+67%', label: 'Binding affinity', color: 'text-green-600' },
        { value: '+43%', label: 'Stability improvement', color: 'text-blue-600' },
        { value: '+89%', label: 'Expression yield', color: 'text-purple-600' }
      ],
      keyFeatures: [
    ...
    },
    {
      ...
      metrics: [
        { value: '96%', label: 'Specificity', color: 'text-green-600' },
        { value: '15.3x', label: 'Expression fold', color: 'text-blue-600' },
        { value: '<2%', label: 'Leakage', color: 'text-purple-600' }
      ],
      keyFeatures: [
        'Tissue specificity',
    ...
    },
    {
      ...
      metrics: [
        { value: '+72%', label: 'Accessibility', color: 'text-green-600' },
        { value: '+56%', label: 'H3K27ac signal', color: 'text-blue-600' },
        { value: '-84%', label: 'Methylation reduction', color: 'text-purple-600' }
      ],
      keyFeatures: [
